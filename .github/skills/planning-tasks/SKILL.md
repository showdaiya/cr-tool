...
name: planning-tasks
description: |
  作業開始前に、実行可能なPlanを必ず作り、今回使用するGitのブランチの情報まで記載する。非自明な作業（コード/AWS/git/設定/ドキュメント構成変更など）で使用する。Planには選択肢比較・検証・リスク・ロールバック・チェックポイント・完了条件・cleanupを含める。
---
...
Gitを活用している。mainからブランチを切ってから作業を始めるプランを作成する
